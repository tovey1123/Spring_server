  ...
  <div id="head-nav" class="navbar navbar-default navbar-fixed-top">
    ...
    <ul class="nav navbar-nav navbar-right user-nav">
      <li class="dropdown profile_menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img alt="Avatar" src="images/avatar2.jpg" /><span>${mp.data.employee_name}</span> <b class="caret"></b></a>
        <ul class="dropdown-menu">
        ...
        <div class="menu-space">
          <div class="content">
            <div class="side-user">
              ...
              <div class="info">
                <a href="#">${mp.data.employee_name}</a>
