...
//            background: currentElement.getAttribute('data-background'),
...
//    
//    if (typeof (targetElement.background) === 'string') {
//      targetElement.element.style.backgroundColor = targetElement.background;
//    }
//   
//    
