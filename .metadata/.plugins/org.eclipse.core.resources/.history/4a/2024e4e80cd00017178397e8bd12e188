...
<title>扁平化bootstrap社交博客类型后台管理模板</title>
...
<div id="switcher">
	...
	<!--
	 ...
	 -->
			<li class="logoTop"><a href="/pins/25299.html">大型预制构件预应力管理系统</a></li>
			<script type="text/javascript">
			jQuery('#output').qrcode({width:150,height: 150,text: window.location.href});
			</script>
			<li class="remove_frame"><a href="http://www.17sucai.com/preview/2/2017-06-28/cleanzone/index.html" title="移除框架"></a></li>
		</ul>
	</div>
</div>

<div id="iframe-wrap">
	<iframe id="iframe" src="http://www.17sucai.com/preview/2/2017-06-28/cleanzone/index.html" frameborder="0"  width="100%"></iframe>
</div>
